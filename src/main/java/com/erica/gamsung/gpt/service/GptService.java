...
public class GptService {
    ...
    private String getPrompt(Posting posting) {
        ...
        String prompt = String.format("""
                    음식점을 인스타그램에 홍보하고 싶어. 사람들의 시선을 끌 수 있는 글을 작성해줘.
                    글 작성 시 고려해야 할 사항 :
                    1. 각 홍보 글은 3문장 정도로 작성해.
                    """);
        if (menu != null) {
        ...
        prompt += String.format("""
                어떻게 답변해줘야하는지 알려줄게.
                위 %d개의 사항(들)을 모두 고려한 서로 다른 홍보 글 3개를 작성해줘. 글 구분은 마지막에 @ 기호 사용하면 돼.
                글 구분하려고 앞에 숫자 넘버링하지 마. 바로 인스타그램에 업로드할 수 있게 깔끔하게 글 써줘.
                """, cnt);
